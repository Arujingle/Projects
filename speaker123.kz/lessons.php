...
$result = mysql_query ("SELECT id,title,discription,author,date FROM lessons",$db);
$myrow = mysql_fetch_array ($result);
do {
printf ("<table align='center' class='tabl'>
        <tr>
          <td class='lesson_title'><p class='lesson_name'> <a href='lesson_show.php?id=%s'>%s</a>
		  </p>
		  <p class='lesson_add'>Дата добавления: %s</p>
		  <p class='lesson_add'>Автор урока: %s</p></td>
        </tr>
      <tr>
          <td >%s</td>
        </tr>
